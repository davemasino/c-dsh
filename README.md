...
The dev shell includes common C tooling (CMocka for testing, Meson + Ninja for builds, pkg-config for dependency discovery) and configures the [Starship](https://starship.rs/) prompt automatically for bash.
